...
exports.paymentsTemplate = async (content) => {
  try {
    ...
    <html lang="en">
      <head>
        ...
        <div class="pdfFlex headerSpace">
          ...
          <span class="pdfTitle">Payments statement</span>
        </div>
      </head>
      <body>
        <div class="mainContainer">
          <div class="accountTitle">DETAILS</div>
          ...
          <div>
            <div class="accountTitle">payments</div>
            <div>
