...
exports.nonReconciledTemplate = async (content) => {
  try {
    ...
    <html lang="en">
      <head>
        ...
        <div class="pdfFlex headerSpace">
          ...
          <span class="pdfTitle">Non-Reconciled statement</span>
        </div>
      </head>
      <body>
        <div class="mainContainer">
          ...
          <div>
            <div class="accountTitle">Non-Reconciled payments</div>
            <div>
              <table class="bodyTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="avenirRmnClr">${payments.description}</td>
                    <td class="avenirRmnClr">${payments.seqNum}</td>
                    <td class="avenirBlkClr"> </td>
                    <td class="avenirBlkClr">${payments.amount}</td>
                  </tr>
                  `
                          )
                          .join("")
		  ...
		  <div>
            <div class="accountTitle">Non-Reconciled transactions</div>
            <div>
              <table class="bodyTable">
                <thead>
                  <tr>
