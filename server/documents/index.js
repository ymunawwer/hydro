  ...
  <html lang="en">
    <head>
      ...
      <div class="pdfFlex headerSpace">
        ...
        <span class="pdfTitle">Banks Statement</span>
      </div>
    </head>
    <body>
      <div class="mainContainer">
        ...
        <div class="detailsSpacing mediumText">
          Name: <span class="blackText">${name}</span>
        </div>
        <div class="detailsSpacing mediumText">
          Email Id: <span class="blackText">${email}</span>
        </div>
        <table class="dateTable detailsSpacing mediumText">
          <tbody>
            <tr>
              <td>Date From: <span class="blackText">${moment(
                stmtStartDate
              ).format("DD/MM/YYYY")}</span></td>
              <td>Date To: <span class="blackText">${moment(stmtEndDate).format(
                "DD/MM/YYYY"
              )}</span></td>
            </tr>
          </tbody>
        ...
        <div>
          <div class="accountTitle">ACCOUNT STATEMENT</div>
          <div>
                  ...
                  !isEmpty(transactions)
                    ? transactions
                        .map(
                          (item, i) => `
                <tr>
                  <td class="avenirRmnClr">${moment(item.date, "YYMMDD").format(
                    "DD/MM/YYYY"
                  )}</td>
                  <td class="avenirRmnClr">${item.desc}</td>
                  <td class="avenirRmnClr">${item.txnId}</td>
